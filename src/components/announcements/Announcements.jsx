...
const Announcements = () => {
  ...
  const handleTypeBtn = (e) => {
    ...
    // filtering
    setFiltered_AnnouncementsData(
      announcementsData.filter((data) => data.news_type === currType)
    )
  }
  ...
  return (
    <>
      ...
      <ClubNews
        heading={'Club News'}
        announcementsData={Filtered_announcementsData}
      >
        <h1>Hello World</h1>
        ...
        <div className="btn-group clubNews_selectType">
          ...
          <div className="dropdown-menu">
            <button className="dropdown-item" onClick={(e) => handleTypeBtn(e)}>
              Overall
            </button>
            <button className="dropdown-item" onClick={(e) => handleTypeBtn(e)}>
              Academy
