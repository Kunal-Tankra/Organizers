...
const MatchListContainer = (props) => {
    const {matcheResults,event_title} = props
    return (
        <div className='matchListContainer'>
            ...
            <div className="allMatches">
                {matcheResults.map(result=><SingleMatch key={result.id} result_short_description={result.result_short_description} team_name1={result.team_name1} team_name2={result.team_name2} team_score1={result.team_score1}   team_score2={result.team_score2} />)}
            </div>
